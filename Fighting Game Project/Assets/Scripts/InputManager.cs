...
public class InputManager : MonoBehaviour
{
    ...
    public bool player1L;
    public bool player1M;
    public bool player1H;
    ...
    private void GetPlayerInputs()
    {
        //Player1
        //Movement Directions
        player1Directions.x = Input.GetAxisRaw("Horizontal");
        player1Directions.y = Input.GetAxisRaw("Vertical");
        //Actions Keys
